...
const int NEIGHB_NUM_PER_LIST = 12;
...
void NNDescentForMerge(NNDElement *knngraph_result_dev_ptr,
                       ...
                       const int vecs_dim, const int split_pos, NNDElement *debug_host_graph, int *host_graph_old,
                       int *host_graph_new, int *host_size_old,
                       int *host_size_new, int* debug_parameters_shrink_graph, int *dbg_new_pre_sort_host, int *dbg_old_pre_sort_host, int *dbg_new_post_sort_host, int *dbg_old_post_sort_host, const int iteration = 6);
